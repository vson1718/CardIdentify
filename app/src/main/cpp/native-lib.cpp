...
Java_com_vson_identify_FaceHelper_loadModel(JNIEnv *env, jclass type,
...
JNIEXPORT void JNICALL
Java_com_vson_identify_FaceHelper_startTracking(JNIEnv *env, jclass type) {
...
JNIEXPORT void JNICALL
Java_com_vson_identify_FaceHelper_stopTracking(JNIEnv *env, jclass type) {
    if (tracker && isTracking) {
        isTracking = 0;
        tracker->stop();
    }
...
JNIEXPORT void JNICALL
Java_com_vson_identify_FaceHelper_setSurface(JNIEnv *env, jclass type, jobject surface,
                                                        jint w, jint h) {
    if (surface && w && h) {
        if (nativeWindow) {
...
JNIEXPORT void JNICALL
Java_com_vson_identify_FaceHelper_detectorFace(JNIEnv *env, jclass type,
...
JNIEXPORT void JNICALL
Java_com_vson_identify_FaceHelper_destroy(JNIEnv *env, jclass type) {
    if (tracker)
        delete tracker;
    tracker = 0;
    if (nativeWindow)
